...
public class Modelabyssius<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "abyssius"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(43, 26)
						.addBox(0.0F, -18.0F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(43, 21)
						...
						.addBox(0.0F, -6.0F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-4.0F, -22.0F, -2.0F, 8.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r1 = Body
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(28, 29).addBox(-3.0F, -7.0F, -1.0F, 1.0F, 1.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 0)
						.addBox(1.0F, -8.0F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(32, 13)
		...
		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(20, 14)
						.addBox(0.0F, -2.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
		...
		PartDefinition cube_r3 = rightarm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(39, 12).addBox(-10.0F, -15.0F, -2.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = rightarm.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(40, 0).addBox(-13.0F, -15.0F, -2.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = leftarm.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(40, 35).addBox(-13.0F, -15.0F, -2.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = leftarm.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(36, 16).addBox(-13.0F, -15.0F, -2.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = leftarm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.1684F, -0.2151F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = leftarm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(35, 43).addBox(-0.4995F, -1.5616F, -0.1459F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 17.0F, 1.0F, 0.303F, 0.0393F, 1.4459F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 18)
						.addBox(-3.0F, -31.0F, -2.0F, 6.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(1.0F, -28.0F, 2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 18)
						.addBox(-2.0F, -28.0F, 2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
