...
public class Modeltrichina<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "trichina"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-3.0F, -19.0F, -4.0F, 6.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(8, 31)
		...
		PartDefinition cube_r1 = RightLeg
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 12).addBox(-37.0F, -15.0F, -1.0F, 28.0F, 2.0F, 2.0F,
		...
		PartDefinition cube_r2 = RightLeg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 8).addBox(-3.0F, -32.0F, -1.0F, 28.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Leftleg
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(0, 4).addBox(-27.3666F, -0.9487F, -1.0F, 28.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2.7925F));

		PartDefinition cube_r4 = Leftleg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 29.0F, -1.0F, 28.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = UpperArm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, 19.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = UpperArm.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(4, 21).addBox(2.0F, 21.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = UpperArm.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(21, 21).addBox(-3.0F, 20.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 20.0F, -1.0F, 2.8798F, 0.0F, 0.0F));

		PartDefinition cube_r8 = UpperArm.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(25, 21).addBox(-6.0F, 22.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = UpperArm.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(8, 29).addBox(7.0F, 23.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = UpperArm.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(16, 40).addBox(-9.0F, 24.0F, 41.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
