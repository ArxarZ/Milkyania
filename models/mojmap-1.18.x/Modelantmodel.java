...
public class Modelantmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "antmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -3.0F, -4.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(7, 9)
		...
		PartDefinition cube_r1 = leg1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 3).addBox(0.0F, -1.0F, -3.0F, 1.0F, 2.0F, 1.0F,
		...
		PartDefinition cube_r2 = leg2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.0F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.1309F));
		...
		PartDefinition cube_r3 = leg3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 3).addBox(0.0F, -1.0F, 1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = leg4
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(8, 0).addBox(-2.0F, -1.0F, -3.0F, 1.0F, 2.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
		...
		PartDefinition cube_r5 = leg5
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(4, 7).addBox(-2.0F, -1.0F, -1.0F, 1.0F, 2.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
		...
		PartDefinition cube_r6 = leg6
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -1.0F, 1.0F, 1.0F, 2.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
