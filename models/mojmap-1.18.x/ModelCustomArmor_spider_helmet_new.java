...
public class ModelCustomArmor_spider_helmet_new<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "customarmor_spider_helmet_new"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorHead = partdefinition.addOrReplaceChild("armorHead",
				CubeListBuilder.create().texOffs(32, 13)
						.addBox(-3.0F, -6.0F, -7.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 6)
		...
		PartDefinition spiderbody = armorHead.addOrReplaceChild("spiderbody",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -35.0F, -5.0F, 8.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(26, 25)
		...
		PartDefinition lefteye = armorHead.addOrReplaceChild("lefteye", CubeListBuilder.create().texOffs(0, 18).addBox(
				-3.0F, -10.0F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition righteye = armorHead.addOrReplaceChild("righteye", CubeListBuilder.create().texOffs(0, 15)
				.addBox(1.0F, -10.0F, -6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition leftlegs = armorHead.addOrReplaceChild("leftlegs",
				CubeListBuilder.create().texOffs(14, 28)
						.addBox(-8.0F, -8.0F, -2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 30)
		...
		PartDefinition rightlegs = armorHead.addOrReplaceChild("rightlegs",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(4.0F, -9.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(6, 3)
