...
import net.mcreator.monkeania.procedures.RubyArmorHelmetTickEventProcedure;
...
public abstract class RubyArmorItem extends ArmorItem {
	...
	public static class Helmet extends RubyArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "monkeania:textures/models/armor/ruby_layer_1.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			RubyArmorHelmetTickEventProcedure.execute(entity);
		}
	}
	...
	public static class Leggings extends RubyArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "monkeania:textures/models/armor/ruby_layer_2.png";
		}
