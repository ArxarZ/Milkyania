...
import net.mcreator.monkeania.procedures.DirtArmorHelmetTickEventProcedure;
...
public abstract class DirtArmorItem extends ArmorItem {
	...
	public static class Helmet extends DirtArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "monkeania:textures/models/armor/dirt_layer_1.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			DirtArmorHelmetTickEventProcedure.execute(entity);
		}
	}
	...
	public static class Leggings extends DirtArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "monkeania:textures/models/armor/dirt_layer_2.png";
		}
