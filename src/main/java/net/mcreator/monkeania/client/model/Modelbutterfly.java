...
public class Modelbutterfly<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("monkeania", "modelbutterfly"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 12).addBox(-1.0F, -2.0F, -3.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(9, 7)
		...
		PartDefinition leftwing = partdefinition
				.addOrReplaceChild(
						"leftwing", CubeListBuilder.create().texOffs(9, 7).addBox(0.0F, -3.0F, -3.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
								.texOffs(0, 6).addBox(1.0F, -4.0F, -3.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition rightwing = partdefinition
				.addOrReplaceChild(
						"rightwing", CubeListBuilder.create().texOffs(9, 1).addBox(-2.0F, -3.0F, -3.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-4.0F, -4.0F, -3.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 24.0F, 0.0F));
