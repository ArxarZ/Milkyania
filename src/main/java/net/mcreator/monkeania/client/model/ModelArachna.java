...
public class ModelArachna<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("monkeania", "model_arachna"), "main");
	public final ModelPart body;
	public final ModelPart head;
	public final ModelPart LeftLeg;
	public final ModelPart LeftLeg2;
	public final ModelPart LeftLeg5;
	public final ModelPart LeftLeg3;
	public final ModelPart RightLeg;
	public final ModelPart RightLeg4;
	public final ModelPart Back;
	public final ModelPart LeftLeg4;
	public final ModelPart LeftLeg6;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, -6.0F));
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(0, 29).addBox(-12.0F, -24.0F, -9.0F, 24.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.0F, -6.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 47).addBox(-1.0F, -8.0F, -5.0F, 9.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 2.0F, -24.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(1.0F, 3.0F, -20.0F));
		PartDefinition LeftLeg_r1 = LeftLeg.addOrReplaceChild("LeftLeg_r1",
				CubeListBuilder.create().texOffs(74, 30).addBox(-12.0F, -14.0F, -17.5F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 21.0F, 8.0F, -1.5892F, -1.3801F, 0.8657F));
		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.0F, 3.0F, -15.0F, 0.0F, -1.5272F, 0.0F));
		PartDefinition LeftLeg_r2 = LeftLeg2.addOrReplaceChild("LeftLeg_r2",
				CubeListBuilder.create().texOffs(24, 66).addBox(-2.0F, 1.9047F, -7.679F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5901F, 1.5F, 5.371F, -0.6545F, 0.0F, 0.0F));
		PartDefinition LeftLeg5 = partdefinition.addOrReplaceChild("LeftLeg5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0F, 3.0F, -10.0F, -0.2636F, -0.5477F, 0.0865F));
		PartDefinition LeftLeg_r3 = LeftLeg5.addOrReplaceChild("LeftLeg_r3",
				CubeListBuilder.create().texOffs(50, 47).addBox(3.2816F, -3.2543F, 1.9737F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.1942F, 1.4155F, -6.5014F, -0.196F, -1.0585F, -0.5518F));
		PartDefinition LeftLeg3 = partdefinition.addOrReplaceChild("LeftLeg3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0F, 4.0F, -6.0F, -0.0436F, -0.6545F, 0.0F));
		PartDefinition LeftLeg_r4 = LeftLeg3.addOrReplaceChild("LeftLeg_r4",
				CubeListBuilder.create().texOffs(12, 66).addBox(0.7816F, -5.2543F, 2.4737F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.6079F, 0.6221F, -4.9825F, -0.196F, -1.0585F, -0.5518F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-7.0F, 4.0F, -20.0F, 0.314F, -1.3169F, 1.0243F));
		PartDefinition RightLeg_r1 = RightLeg.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(66, 0).addBox(-0.6398F, -1.111F, -1.1261F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4132F, 0.3564F, 0.1107F, -0.663F, -0.1802F, 0.2619F));
		PartDefinition RightLeg4 = partdefinition.addOrReplaceChild("RightLeg4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-7.0F, 3.0F, -4.0F, 0.0F, 1.4399F, 0.0F));
		PartDefinition RightLeg_r2 = RightLeg4.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(62, 47).addBox(-13.0F, -16.5F, 14.0F, 3.0F, 27.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.4277F, 21.0F, 7.7322F, -2.5454F, -0.5042F, -3.0412F));
		PartDefinition Back = partdefinition.addOrReplaceChild("Back",
				CubeListBuilder.create().texOffs(0, 0).addBox(-10.5F, -26.0F, 0.0F, 15.0F, 11.0F, 18.0F, new CubeDeformation(0.0F)),
