...
public class Modelspiderchestplate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("monkeania", "modelspiderchestplate"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mainchestplate = Body.addOrReplaceChild("mainchestplate",
				CubeListBuilder.create().texOffs(18, 24).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(62, 46)
		...
		PartDefinition cube_r1 = mainchestplate.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(7, 30).addBox(2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(21, 37)
		...
		PartDefinition cube_r2 = mainchestplate.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 53).addBox(-4.0F, 13.0F, -3.0F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(40, 53)
		...
		PartDefinition cube_r3 = mainchestplate.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(13, 48).addBox(1.0F, 12.0F, -3.0F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 55)
		...
		PartDefinition cube_r4 = mainchestplate.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(12, 58).addBox(7.3051F, 0.0F, 13.5202F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-12.0F, 0.0F, 0.0F, 0.0F, 0.8727F, 0.0F));
		PartDefinition cube_r5 = mainchestplate.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(25, 51).addBox(-5.0F, 0.0F, -2.0F, 1.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition cube_r6 = mainchestplate.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(41, 67).addBox(-2.0F, 7.0F, -10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(51, 67)
						...
						.addBox(0.0F, 7.0F, -10.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(68, 38).addBox(-1.0F, 7.0F, -10.0F, 1.0F,
								1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6981F, 0.0F, 0.0F));
		PartDefinition cube_r7 = mainchestplate.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(36, 9).addBox(-1.0F, 0.0F, -6.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.8727F, 0.0F));
		PartDefinition cube_r8 = mainchestplate.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(18, 58).addBox(0.0F, 0.0F, -5.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.5672F, 0.0F));
		PartDefinition cube_r9 = mainchestplate.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(18, 17).addBox(-1.0F, 0.0F, -6.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.8727F, 0.0F));
		PartDefinition cube_r10 = mainchestplate.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(31, 58).addBox(-3.0F, 0.0F, -5.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));
		PartDefinition cagethingy = mainchestplate.addOrReplaceChild("cagethingy", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r11 = cagethingy.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(67, 31).addBox(-4.0F, 3.0F, -6.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = cagethingy.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(67, 26).addBox(3.0F, 6.0F, -5.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = cagethingy.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(67, 34).addBox(1.0F, 4.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = cagethingy.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(67, 14).addBox(1.0F, 2.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = cagethingy.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(67, 23).addBox(-2.0F, 2.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = cagethingy.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(67, 11).addBox(-3.0F, 5.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = cagethingy.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(24, 67).addBox(2.0F, 5.0F, 4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = cagethingy.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(67, 19).addBox(5.0F, 5.0F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = heartthing.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(60, 14).addBox(1.0F, 5.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.6981F, 0.0F));
		PartDefinition cube_r20 = heartthing.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(59, 55).addBox(-4.0F, -4.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = heartthing.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(59, 57).addBox(-1.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(60, 5)
						.addBox(-2.0F, 4.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(60, 7).addBox(-2.0F, 5.0F, -5.0F, 1.0F, 1.0F,
		...
		PartDefinition cube_r22 = heartthing.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(55, 50).addBox(2.0F, 2.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 57)
						.addBox(2.0F, 3.0F, -5.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(59, 41).addBox(2.0F, 3.0F, -5.0F, 1.0F, 1.0F,
								1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = heartthing.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(60, 12).addBox(-4.0F, 4.0F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 68)
		...
		PartDefinition right = partdefinition.addOrReplaceChild("right",
				CubeListBuilder.create().texOffs(36, 7).addBox(-10.0F, -2.0F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(18, 17)
		...
		PartDefinition cube_r24 = right.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(36, 21).addBox(-6.0F, 1.0F, -3.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(31, 51)
						.addBox(-8.0F, 2.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(52, 12).addBox(-10.0F, 2.0F, -3.0F, 1.0F,
		...
		PartDefinition left = partdefinition.addOrReplaceChild("left",
				CubeListBuilder.create().texOffs(34, 0).addBox(5.0F, -2.0F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(18, 10)
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r25 = left.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(52, 25).addBox(6.0F, -8.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.5672F));
		PartDefinition cube_r26 = left.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(47, 48).addBox(3.0F, -7.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.829F));
		PartDefinition cube_r27 = left.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(38, 28).addBox(2.0F, 1.0F, -3.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
