 ...
 *
 */
package net.mcreator.monkeania;
...
@Mod("monkeania")
public class MonkeaniaMod {
	public static final Logger LOGGER = LogManager.getLogger(MonkeaniaMod.class);
	public static final String MODID = "monkeania";
	...
	public MonkeaniaMod() {
		...
		MonkeaniaModBlocks.REGISTRY.register(bus);
		MonkeaniaModItems.REGISTRY.register(bus);
