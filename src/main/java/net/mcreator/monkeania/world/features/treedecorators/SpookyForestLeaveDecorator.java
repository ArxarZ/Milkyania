...
public class SpookyForestLeaveDecorator extends LeaveVineDecorator {
	public static final SpookyForestLeaveDecorator INSTANCE = new SpookyForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("spooky_forest_tree_leave_decorator");
