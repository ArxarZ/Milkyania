...
public class SapphireOreFeature extends OreFeature {
	...
	private static class SapphireOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<SapphireOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<SapphireOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("monkeania:sapphire_ore_match"), CUSTOM_MATCH);
		}
