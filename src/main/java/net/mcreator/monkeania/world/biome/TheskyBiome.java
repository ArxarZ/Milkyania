...
public class TheskyBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.142857142857f, 0.142857142857f),
			...
			Climate.Parameter.span(-0.796171484424f, -0.51045719871f), 0);
	...
	public static Biome createBiome() {
		...
		mobSpawnInfo.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(MonkeaniaModEntities.GHOST.get(), 10, 1, 1));
