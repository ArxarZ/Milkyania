...
public class ButterflyEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(MonkeaniaModEntities.BUTTERFLY.get(), 20, 1, 4));
	}

	public ButterflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MonkeaniaModEntities.BUTTERFLY.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				Random random = ButterflyEntity.this.getRandom();
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MonkeaniaModItems.BUTTERFLYITEM.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(MonkeaniaModEntities.BUTTERFLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
