...
public class FlyEntity extends Monster {
	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(MonkeaniaModEntities.FLY.get(), 25, 1, 4));
	}

	public FlyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MonkeaniaModEntities.FLY.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MonkeaniaModItems.FLY_ITEM.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(MonkeaniaModEntities.FLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos,
						random) -> (world.getBlockState(pos.below()).getMaterial() == Material.GRASS && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(MonkeaniaModEntities.FLY.get(), 180);
	}
